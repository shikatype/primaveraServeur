	...
	<div class="container">
		<div class="jumbotron">
			<form class="form-horizontal" method="POST">
				...
				<input type="hidden" name="idGroupe" value="${idgroupe}"> <input
					type="hidden" name="iduser" value="${user.iduser}"> <input
...
<div class="container" style="width: 300px; height: 200px;" id="carteAlerte"></div>
				...
				<c:if test="${!fiche.rempli}">
					<input class="btn btn-primary" type="submit" value="Envoyer"
						formaction="/primaveraServeur/envoieFicheGroupe">
				</c:if>
			...
			<input class="btn btn-primary" type="submit" value="Retour"
					formaction="/primaveraServeur/groupe">
					</form>
		</div>
	</div>
