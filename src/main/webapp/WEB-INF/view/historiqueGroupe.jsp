			...
			<form class="form-horizontal" method="POST">
				...
				<div class="table-responsive">
					...
					<table id="example" class="table table-striped table-bordered">
						...
						<tbody>
							<c:forEach items="${listeGroupe}" var="liste">
								...
								<tr class="default">
									...
									<td>
										<form method="POST">
											<input type="hidden" name="etatName"
												value="${etat}"> <input type="hidden" name="iduser"
												value="${user.iduser}"> <input type="hidden"
												name="idGroupe" value="${liste.idgroupe}"> <input
												type="submit" class="btn btn-info" value="Détails"
												formaction="/primaveraServeur/groupe"> <input
												type="submit" class="btn btn-default" value="carte"
					...
					<c:if test="${not empty listeGroupe }">
					<c:if test="${etatPlus}">
						<c:if test="${creationGroupe}">
